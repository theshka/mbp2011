...
<div class="modal fade black" id="tos-modal" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" data-dismiss="modal" type="button"><span>&times;</span><span class="sr-only">Close</span></button>

				<h3 class="modal-title">Web Site Terms and Conditions</h3>
			</div>

			<div class="modal-body overflowing" style="height: 600px;">
				<h3>
					1. Terms
				</h3>
				...
				<ol type="a">
					<li>
						...
						(information or software) on #MBP2011's web site for personal,
						...
						<ol type="i">
							...
							<li>attempt to decompile or reverse engineer any software contained on #MBP2011's web site;</li>
							<li>remove any copyright or other proprietary notations from the materials; or</li>
							<li>transfer the materials to another person or "mirror" the materials on any other server.</li>
						</ol>
					</li>
					<li>
						This license shall automatically terminate if you violate any of these restrictions and may be terminated by #MBP2011 at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.
					</li>
				</ol>
				...
				<ol type="a">
					<li>
						The materials on #MBP2011's web site are provided "as is". #MBP2011 makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, #MBP2011 does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.
					</li>
				</ol>
				...
				<p>
					In no event shall #MBP2011 or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on #MBP2011's Internet site, even if #MBP2011 or a #MBP2011 authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.
				</p>
				...
				<p>
					The materials appearing on #MBP2011's web site could include technical, typographical, or photographic errors. #MBP2011 does not warrant that any of the materials on its web site are accurate, complete, or current. #MBP2011 may make changes to the materials contained on its web site at any time without notice. #MBP2011 does not, however, make any commitment to update the materials.
				</p>
				...
				<p>
					#MBP2011 has not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by #MBP2011 of the site. Use of any such linked web site is at the user's own risk.
				</p>
				...
				<p>
					#MBP2011 may revise these terms of use for its web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.
				</p>
				...
				<p>
					Any claim relating to #MBP2011's web site shall be governed by the laws of the Country of Canada without regard to its conflict of law provisions.
				</p>
				<p>
					<b><?php echo "Last modified: " . date ("F d, Y", getlastmod()); ?></b>
				</p>
			</div>
		</div>
	</div>
...
<div class="modal fade black" id="privacy-modal" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" data-dismiss="modal" type="button"><span>&times;</span><span class="sr-only">Close</span></button>
			...
			<div class="modal-body overflowing" style="height: 600px;">
				This Privacy Policy governs the manner in which #MBP2011 collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="https://mbp2011.org">https://mbp2011.org</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by #MBP2011.<br><br>
				...
				#MBP2011 may collect and use Users personal information for the following purposes:<br>
				<ul>
