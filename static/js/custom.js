...
function googleTranslateElementInit() {
	new google.translate.TranslateElement({
		pageLanguage: 'en',
		includedLanguages: 'en,es,de,it,fr,nl,zh,de,he,ko,fi,ja,da,ru',
		gaTrack: true,
		gaId: 'UA-48501333-2',
...
function backtotop() {
	...
	jQuery(window).scroll(function() {
		if (jQuery(this).scrollTop() > soffset) {
			jQuery('.back-to-top').fadeIn(sduration);
		}
		else {
			jQuery('.back-to-top').fadeOut(sduration);
		}
	});
	// Back To Top Clicked
