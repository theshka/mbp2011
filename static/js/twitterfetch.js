    ...
    return {
        ...
        callback: function (e) {
            ...
            for (a = 0; a < d;) {
                ...
                A && (b += '<span class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + h[a] + '" target="_BLANK" class="twitter_reply_icon"> &#xf112; </a>|<a href="https://twitter.com/intent/retweet?tweet_id=' + h[a] + '" target="_BLANK" class="twitter_retweet_icon"> &#xf079; </a>|<a href="https://twitter.com/intent/favorite?tweet_id=' + h[a] + '" target="_BLANK" class="twitter_fav_icon"> &#xf005; </a></span>');
                c.push(b);
                a++
            }
            if (null == w) {
...
function handleTweets(tweets) {
    ...
    while (n < x) {
    	   if (n == 0) { html += '<div class="item active"><blockquote>' + tweets[n] + '</blockquote></div>'; }
        html += '<div class="item"><blockquote>' + tweets[n] + '</blockquote></div>';
        n++;
    }
    html += '</div>';
    html += '<a onClick="$(\'#testimonials-inner\').carousel(\'prev\');" class="left carousel-control" ><i class="fa fa-chevron-left"></i></a>';
    html += '<a onClick="$(\'#testimonials-inner\').carousel(\'next\');" class="right carousel-control" ><i class="fa fa-chevron-right"></i></a>';
